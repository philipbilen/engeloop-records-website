        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-100">
            ...
            <p className="text-gray-500 mb-6 leading-relaxed text-large">
              ...
              label specializing in Afro House and Deep House music. We´re
              passionate about discovering and promoting exceptional electronic
              music that moves both body and soul.
            </p>
            <p className="text-gray-500 leading-relaxed text-large">
              ...
              worldwide. We believe in building long-term relationships with our
              artists and helping them develop their unique sound.
            </p>
          </div>
